...
module.exports.config = {
 ...
 module.exports.run = function({ api, event, args, getText }) {
  ...
  if (args[0] == "all") {
    ...
    let i = 0;
    let msg = "🎭Danh sách lệnh BOT HChong hiện có🎭\n\n";
