...
module.exports.run = async function ({ api, args, event, Currencies, Users }) {
  const axios = require("axios");
    ...
    const datagame = (await axios.get("https://Api-UwU.truccuche27042004.repl.co/game/vuatiengviet")).data;
    const random = datagame.keyword;
    const answer = datagame;
    let Avatar = (await axios.get(`https://Api-UwU.truccuche27042004.repl.co/vuatiengviet/image?word=${encodeURI(random)}`, { responseType: "arraybuffer" } )).data; 
